...
public class ClientUtil extends Util{
    ...
    public final static void printUserMainMenu(final User user) {
        ...
        print(String.format("%-18s %5s %-40s%n", UserMenuAction.LIST_PORTFOLIOS.getActionName(), " ", UserMenuAction.LIST_PORTFOLIOS.getActionDescription()));
        print(String.format("%-18s %5s %-40s%n", UserMenuAction.VIEW_PORTFOLIO.getActionName(), " ", UserMenuAction.VIEW_PORTFOLIO.getActionDescription()));
        print(String.format("%-18s %5s %-40s%n", UserMenuAction.SIMULATE_PORTFOLIO.getActionName(), " ", UserMenuAction.SIMULATE_PORTFOLIO.getActionDescription()));
