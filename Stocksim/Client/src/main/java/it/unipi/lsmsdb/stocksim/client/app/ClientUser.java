...
/**
 * StockSim User Client implementation.
 *
...
public class ClientUser {
    ...
    private final DBManager factory = new DBManager();
     ...
     */
    private void searchIn(String attribute) {
     ...
     * @param attribute the attribute which to perform the search
     */
    private void searchBy(String attribute) {
     ...
     */
    private void showPortfolio(Portfolio p) {
     ...
     */
    private void showTitleDetails(Title t, Double portfolioTotInv) {
        ClientUtil.println(
     ...
     */
    private void deletePortfolio(Portfolio p) {
